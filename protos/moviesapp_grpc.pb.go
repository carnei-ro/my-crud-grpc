...
const (
	Movie_GetMovies_FullMethodName   = "/mycrudgrpc.Movie/GetMovies"
	Movie_GetMovie_FullMethodName    = "/mycrudgrpc.Movie/GetMovie"
	Movie_CreateMovie_FullMethodName = "/mycrudgrpc.Movie/CreateMovie"
	Movie_UpdateMovie_FullMethodName = "/mycrudgrpc.Movie/UpdateMovie"
	Movie_DeleteMovie_FullMethodName = "/mycrudgrpc.Movie/DeleteMovie"
)
...
type MovieClient interface {
	...
	GetMovie(ctx context.Context, in *Uuid, opts ...grpc.CallOption) (*MovieInfo, error)
	CreateMovie(ctx context.Context, in *MovieInfo, opts ...grpc.CallOption) (*Uuid, error)
	UpdateMovie(ctx context.Context, in *MovieInfo, opts ...grpc.CallOption) (*Status, error)
	DeleteMovie(ctx context.Context, in *Uuid, opts ...grpc.CallOption) (*Status, error)
}
...
func (c *movieClient) GetMovie(ctx context.Context, in *Uuid, opts ...grpc.CallOption) (*MovieInfo, error) {
	out := new(MovieInfo)
...
func (c *movieClient) CreateMovie(ctx context.Context, in *MovieInfo, opts ...grpc.CallOption) (*Uuid, error) {
	out := new(Uuid)
...
func (c *movieClient) DeleteMovie(ctx context.Context, in *Uuid, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
...
type MovieServer interface {
	...
	GetMovie(context.Context, *Uuid) (*MovieInfo, error)
	CreateMovie(context.Context, *MovieInfo) (*Uuid, error)
	UpdateMovie(context.Context, *MovieInfo) (*Status, error)
	DeleteMovie(context.Context, *Uuid) (*Status, error)
...
func (UnimplementedMovieServer) GetMovie(context.Context, *Uuid) (*MovieInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMovie not implemented")
}
func (UnimplementedMovieServer) CreateMovie(context.Context, *MovieInfo) (*Uuid, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateMovie not implemented")
}
func (UnimplementedMovieServer) UpdateMovie(context.Context, *MovieInfo) (*Status, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateMovie not implemented")
}
func (UnimplementedMovieServer) DeleteMovie(context.Context, *Uuid) (*Status, error) {
...
func _Movie_GetMovie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServer).GetMovie(ctx, req.(*Uuid))
	}
...
func _Movie_DeleteMovie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServer).DeleteMovie(ctx, req.(*Uuid))
	}
	return interceptor(ctx, in, info, handler)
}
